...
export default function Profile() {
  return (
    <Box component={'section'} id="home" mt={{xs: 4, sm: 10}} display={'flex'} flexDirection={{xs: 'column', sm: 'row', md: 'row'}} justifyContent={{xs: 'center', sm: 'center', md: 'flex-start'}}>
        ...
        <Box m={3} display={'flex'} flexDirection={'column'} gap={3}>
            ...
            <Button sx={{width: {xs: '100%', md: '30%'}}} variant="contained" color="info">Contactame</Button>
        </Box>
    </Box>
  )
}
